import { require_hoist_non_react_statics_cjs } from "./chunk-EU6QCHT3.js";
import { require_react } from "./chunk-ZAUFE7H7.js";
import { __commonJS, __toESM } from "./chunk-UXIASGQL.js";
...
function stylis_min(W2) {
  function M2(d2, c2, e2, h, a2) {
          ...
          case 123:
            ...
            switch (q2) {
              case 64:
                ...
                0 < A2 &&
                  ((r2 = X2(O2, f, I2)),
                  (C2 = H2(3, k2, r2, c2, D2, z2, t2, g2, a2, h)),
                  (f = r2.join("")),
                  void 0 !== C2 &&
                    0 === (t2 = (k2 = C2.trim()).length) &&
                    ((g2 = 0), (k2 = "")));
                if (0 < t2)
                  switch (g2) {
                    case 115:
          ...
          case 59:
            ...
            if (1 < (t2 = f.length))
              switch (
                ...
                0 < A2 &&
                  void 0 !==
                    (C2 = H2(1, f, c2, d2, D2, z2, p.length, h, a2, h)) &&
                  0 === (t2 = (f = C2.trim()).length) &&
                  (f = "\0\0"),
                (q2 = f.charCodeAt(0)),
                (g2 = f.charCodeAt(1)),
                q2)
    ...
    if (0 < t2) {
      ...
      if (
        0 < A2 &&
        ((C2 = H2(2, p, r2, d2, D2, z2, t2, h, a2, h)),
        void 0 !== C2 && 0 === (p = C2).length)
      )
        return G3 + p + F3;
      p = r2.join(",") + "{" + p + "}";
      if (0 !== w2 * E2) {
    ...
    switch (m2) {
      ...
      case 975:
        ...
        switch ((m2 = b2.charCodeAt(0) + (b2.charCodeAt(7) | 0))) {
          ...
          case 102:
            a2 =
              a2.replace(b2, "-webkit-" + (102 < m2 ? "inline-" : "") + "box") +
              ";" +
      ...
      case 953:
        if (true === la.test(d2))
          return 115 === (b2 = d2.substring(d2.indexOf(":") + 1)).charCodeAt(0)
            ? P2(d2.replace("stretch", "fill-available"), c2, e2, h).replace(
                ":fill-available",
                ":stretch"
              )
            : a2.replace(b2, "-webkit-" + b2) +
  ...
  function B2(d2, c2) {
    ...
    0 < A2 &&
      ((h = H2(-2, a2, e2, e2, D2, z2, a2.length, 0, 0, 0)),
      void 0 !== h && (a2 = h));
    V2 = "";
    E2 = 0;
    z2 = D2 = 1;
    ...
    if (i2) {
      ...
      if (a2) {
        var c2 = 0 | parseInt(a2[1], 10),
          u2 = a2[2];
        0 !== c2 &&
          (z(u2, c2), L(e2, u2, a2[3]), e2.getTag().insertRules(c2, r2)),
          (r2.length = 0);
      } else r2.push(i2);
    }
  }
...
var q = function (e2) {
  ...
  r2.setAttribute(N, "active"),
    r2.setAttribute("data-styled-version", "5.3.11");
  var i2 = Y();
  ...
  function e2(e3, t3, n2) {
    void 0 === e3 && (e3 = w),
      ...
      !this.server &&
        ...
        (function (e4) {
          for (
            var t4 = document.querySelectorAll(M), n3 = 0, r2 = t4.length;
            n3 < r2;
            n3++
          ) {
            var o2 = t4[n3];
            o2 &&
              "active" !== o2.getAttribute(N) &&
              (F(e4, o2), o2.parentNode && o2.parentNode.removeChild(o2));
          }
        })(this));
  }
...
function ae(e2) {
  var t2,
    ...
    f = function (e3, r3, s3) {
      return (0 === r3 && -1 !== ie.indexOf(s3[n2.length])) || s3.match(o2)
        ? e3
        : "." + t2;
    };
...
function me(e2) {
  var t2 = (0, import_react.useState)(e2.stylisPlugins),
    n2 = t2[0],
    s2 = t2[1],
    c2 = pe(),
  ...
  return (
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        le.Provider,
        { value: l2 },
        true ? import_react.default.Children.only(e2.children) : e2.children
      )
    )
  );
}
...
var Ge = Me.Consumer;
function Le(e2) {
  var t2 = (0, import_react.useContext)(Me),
    n2 = (0, import_react.useMemo)(
      function () {
        return (function (e3, t3) {
          if (!e3) return D(14);
          if (E(e3)) {
            var n3 = e3(t3);
            return null !== n3 && !Array.isArray(n3) && "object" == typeof n3
              ? n3
              : D(7);
          }
          return Array.isArray(e3) || "object" != typeof e3
            ? D(8)
            : t3
            ? y({}, t3, {}, e3)
            : e3;
  ...
  var o2 = _(e2),
    ...
    v2 =
      t2.displayName && t2.componentId
        ? je(t2.displayName) + "-" + t2.componentId
        : t2.componentId || d2,
    g2 =
      o2 && e2.attrs
        ? Array.prototype.concat(e2.attrs, c2).filter(Boolean)
        : c2,
    N2 = t2.shouldForwardProp;
  o2 &&
    ...
    (N2 = t2.shouldForwardProp
      ...
      : e2.shouldForwardProp);
  var A2,
    C2 = new oe(n2, v2, o2 ? e2.componentStyle : void 0),
    I2 = C2.isStatic && 0 === c2.length,
    P2 = function (e3, t3) {
      return (function (e4, t4, n3, r2) {
        var o3 = e4.attrs,
          ...
          l3 = e4.shouldForwardProp,
          d3 = e4.styledComponentId,
          h2 = e4.target,
          p2 = (function (e5, t5, n4) {
            void 0 === e5 && (e5 = w);
            var r3 = y({}, t5, { theme: e5 }),
              o4 = {};
            return (
          ...
          })(Oe(t4, (0, import_react.useContext)(Me), a3) || w, t4, o3),
          m2 = p2[0],
          v3 = p2[1],
          g3 = (function (e5, t5, n4, r3) {
            var o4 = pe(),
              s2 = fe(),
              i4 = t5
                ? e5.generateAndInjectStyles(w, o4, s2)
                : e5.generateAndInjectStyles(n4, o4, s2);
            return !t5 && r3 && r3(i4), i4;
          })(i3, r2, m2, true ? e4.warnTooManyClasses : void 0),
          S2 = n3,
          b2 = v3.$as || t4.$as || v3.as || t4.as || h2,
          _2 = xe(b2),
          N3 = v3 !== t4 ? y({}, t4, {}, v3) : t4,
          A3 = {};
        for (var C3 in N3)
          "$" !== C3[0] &&
            ...
            ("forwardedAs" === C3
              ? (A3.as = N3[C3])
              : (l3 ? l3(C3, isPropValid, b2) : !_2 || isPropValid(C3)) &&
                (A3[C3] = N3[C3]));
        return (
          t4.style &&
            v3.style !== t4.style &&
            (A3.style = y({}, t4.style, {}, v3.style)),
          (A3.className = Array.prototype
            .concat(c3, d3, g3 !== d3 ? g3 : null, t4.className, v3.className)
            .filter(Boolean)
            .join(" ")),
          (A3.ref = S2),
          (0, import_react.createElement)(b2, A3)
        );
      })(A2, e3, t3, I2);
    };
  return (
    (P2.displayName = p),
    ((A2 = import_react.default.forwardRef(P2)).attrs = g2),
    (A2.componentStyle = C2),
    (A2.displayName = p),
    (A2.shouldForwardProp = N2),
    (A2.foldedComponentIds = o2
      ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId)
      : S),
    (A2.styledComponentId = v2),
    (A2.target = o2 ? e2.target : e2),
    (A2.withComponent = function (e3) {
    ...
    Pe(p, v2),
    (A2.warnTooManyClasses = (function (e3, t3) {
      var n3 = {},
        r2 = false;
      return function (o3) {
    ...
    Object.defineProperty(A2, "toString", {
      value: function () {
        return "." + A2.styledComponentId;
      },
    }),
    i2 &&
      (0, import_hoist_non_react_statics.default)(A2, e2, {
        attrs: true,
        componentStyle: true,
        displayName: true,
...
var qe = function (e2) {
  return (function e3(t2, r2, o2) {
    if (
      (void 0 === o2 && (o2 = w), !(0, import_react_is.isValidElementType)(r2))
    )
...
var He = (function () {
  ...
  return (
    ...
    (t2.renderStyles = function (e3, t3, n2, r2) {
      e3 > 2 && X.registerId(this.componentId + e3),
...
function $e(e2) {
  for (
    var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), o2 = 1;
    o2 < t2;
    o2++
  )
  ...
  function d2(e3) {
    var t3 = pe(),
      n3 = fe(),
      o3 = (0, import_react.useContext)(Me),
      d3 = (0, import_react.useRef)(t3.allocateGSInstance(a2)).current;
    return (
      import_react.default.Children.count(e3.children) &&
        console.warn(
...
var Ue = (function () {
  function e2() {
    ...
    (this._emitSheetCSS = function () {
      ...
      (this.instance = new X({ isServer: true })),
      (this.sealed = false);
  }
  var t2 = e2.prototype;
  return (
    (t2.collectStyles = function (e3) {
      return this.sealed
        ? D(2)
        : import_react.default.createElement(me, { sheet: this.instance }, e3);
    }),
...
var Je = function (e2) {
  var t2 = import_react.default.forwardRef(function (t3, n2) {
    var o2 = (0, import_react.useContext)(Me),
      i2 = e2.defaultProps,
      a2 = Oe(t3, o2, i2);
    return (
      void 0 === a2 &&
      ...
      import_react.default.createElement(e2, y({}, t3, { theme: a2, ref: n2 }))
    );
  });
  return (
    (0, import_hoist_non_react_statics.default)(t2, e2),
    (t2.displayName = "WithTheme(" + b(e2) + ")"),
    t2
  );
};
var Xe = function () {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SET54HPE.js.map
