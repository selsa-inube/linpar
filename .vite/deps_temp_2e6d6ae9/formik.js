...
function assignValue(object, key, value) {
  ...
  if (
    !(hasOwnProperty6.call(object, key) && eq_default(objValue, value)) ||
...
var isArguments = baseIsArguments_default(
  ...
  : function (value) {
      return (
        ...
        hasOwnProperty7.call(value, "callee") &&
...
function isPrototype(value) {
  var Ctor = value && value.constructor,
    proto = (typeof Ctor == "function" && Ctor.prototype) || objectProto10;
  return value === proto;
}
...
function baseKeysIn(object) {
  ...
  for (var key in object) {
    if (
      !(
        key == "constructor" &&
        (isProto || !hasOwnProperty10.call(object, key))
      )
    ) {
      result.push(key);
    }
...
function initCloneArray(array) {
  ...
  if (
    ...
    hasOwnProperty11.call(array, "index")
  ) {
...
function isSymbol(value) {
  return (
    typeof value == "symbol" ||
    (isObjectLike_default(value) && baseGetTag_default(value) == symbolTag3)
  );
}
...
function useFormikContext() {
  ...
  !!!formik
    ? true
      ...
      : tiny_warning_esm_default(false)
    : void 0;
  return formik;
}
...
function useFormik(_ref) {
  var _ref$validateOnChange = _ref.validateOnChange,
    validateOnChange =
      _ref$validateOnChange === void 0 ? true : _ref$validateOnChange,
    _ref$validateOnBlur = _ref.validateOnBlur,
    validateOnBlur =
      _ref$validateOnBlur === void 0 ? true : _ref$validateOnBlur,
    _ref$validateOnMount = _ref.validateOnMount,
    validateOnMount =
      _ref$validateOnMount === void 0 ? false : _ref$validateOnMount,
    isInitialValid = _ref.isInitialValid,
    _ref$enableReinitiali = _ref.enableReinitialize,
    enableReinitialize =
      _ref$enableReinitiali === void 0 ? false : _ref$enableReinitiali,
  ...
  var initialErrors = (0, import_react.useRef)(
    props.initialErrors || emptyErrors
  );
  var initialTouched = (0, import_react.useRef)(
  ...
  var _React$useState = (0, import_react.useState)(0),
  ...
  var runValidateHandler = (0, import_react.useCallback)(
  ...
  var runValidationSchema = (0, import_react.useCallback)(
    function (values, field) {
      var validationSchema = props.validationSchema;
      var schema = isFunction2(validationSchema)
  ...
  var runSingleFieldLevelValidation = (0, import_react.useCallback)(function (
    field,
    value
  ) {
  ...
  []);
  var runFieldLevelValidations = (0, import_react.useCallback)(
    function (values) {
  ...
  var runAllValidations = (0, import_react.useCallback)(
    function (values) {
      return Promise.all([
        ...
        var combinedErrors = es_default.all(
  ...
  (0, import_react.useEffect)(
    function () {
      if (
        validateOnMount &&
        isMounted.current === true &&
        (0, import_react_fast_compare.default)(
  ...
  var resetForm = (0, import_react.useCallback)(
    function (nextState) {
      var values =
  ...
  var validateField = useEventCallback(function (name) {
    if (
      ...
      isFunction2(fieldRegistry.current[name].validate)
    ) {
  ...
  var setTouched = useEventCallback(function (touched, shouldValidate) {
    ...
    var willValidate =
      shouldValidate === void 0 ? validateOnBlur : shouldValidate;
    return willValidate
  ...
  var setValues = useEventCallback(function (values, shouldValidate) {
    ...
    var willValidate =
      shouldValidate === void 0 ? validateOnChange : shouldValidate;
    return willValidate
  ...
  var executeChange = (0, import_react.useCallback)(
  ...
  var executeBlur = (0, import_react.useCallback)(
    function (e, path) {
      if (e.persist) {
        e.persist();
      }
  ...
  var getFieldMeta = (0, import_react.useCallback)(
    function (name) {
      return {
  ...
  var getFieldHelpers = (0, import_react.useCallback)(
    function (name) {
      return {
  ...
  var getFieldProps = (0, import_react.useCallback)(
  ...
  var dirty = (0, import_react.useMemo)(
    function () {
  ...
  var isValid = (0, import_react.useMemo)(
    function () {
      return typeof isInitialValid !== "undefined"
        ? dirty
          ? state.errors && Object.keys(state.errors).length === 0
          : isInitialValid !== false && isFunction2(isInitialValid)
...
function Formik(props) {
  ...
  return (0, import_react.createElement)(
    ...
    component
      ? (0, import_react.createElement)(component, formikbag)
      : render
      ? render(formikbag)
      : children
      ? isFunction2(children)
        ? children(formikbag)
  ...
  source.forEach(function merge(e, i) {
    if (typeof destination[i] === "undefined") {
      ...
      destination[i] = shouldClone
        ? es_default(Array.isArray(e) ? [] : {}, e, options)
        : e;
...
function useField(propsOrFieldName) {
  ...
  !fieldName
    ? true
      ...
      : tiny_warning_esm_default(false)
    : void 0;
  var fieldHelpers = (0, import_react.useMemo)(
    function () {
...
function Field(_ref) {
  ...
  var _useFormikContext = useFormikContext(),
    formik = _objectWithoutPropertiesLoose(_useFormikContext, [
      "validate",
      "validationSchema",
    ]);
  if (true) {
    (0, import_react.useEffect)(function () {
      !!render
        ? true
          ...
          : tiny_warning_esm_default(false)
        : void 0;
      !!(is && children && isFunction2(children))
        ? true
          ? tiny_warning_esm_default(
              false,
          ...
          : tiny_warning_esm_default(false)
        : void 0;
      !!(component && children && isFunction2(children))
        ? true
          ? tiny_warning_esm_default(
              false,
    ...
    var C = (function (_React$Component) {
      ...
      function C2() {
        ...
        _this.validationSchema = function () {
          return isFunction2(config.validationSchema)
        ...
        _this.renderFormComponent = function (formikProps) {
          return (0, import_react.createElement)(
            Component$1,
            _extends({}, _this.props, formikProps)
          );
        };
        return _this;
      }
...
var createAlterationHandler = function createAlterationHandler2(
  alteration,
  defaultFunction
) {
...
var FieldArrayInner = (function (_React$Component) {
  ...
  _proto.remove = function remove(index) {
    ...
    this.updateArrayField(
      ...
      function (array) {
        ...
        return isFunction2(copy.every)
          ? copy.every(function (v) {
              return v === void 0;
            })
            ? []
            : copy
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
      ...
      render2 = _this$props2.render,
      children = _this$props2.children,
      name = _this$props2.name,
      _this$props2$formik = _this$props2.formik,
      restOfFormik = _objectWithoutPropertiesLoose(_this$props2$formik, [
        "validate",
        "validationSchema",
      ]);
    ...
    return component
      ? (0, import_react.createElement)(component, props)
      : render2
      ? render2(props)
      : children
    ...
    return !!touch && !!error
      ? render2
        ...
        ? isFunction2(children)
          ...
          : null
        : component
        ? (0, import_react.createElement)(component, rest, error)
        : error
      : null;
  };
