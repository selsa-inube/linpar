import { require_react_dom } from "./chunk-D5SJRT53.js";
...
function createRouter(init) {
  ...
  if (hasLazyRoutes) {
    ...
    initialized = initialMatches.every(
      (m) =>
        ...
        ((loaderData && loaderData[m.route.id] !== void 0) ||
          (errors && errors[m.route.id] !== void 0))
    );
  } else {
  ...
  async function handleLoaders(
    ...
    if (redirect3) {
      if (redirect3.idx >= matchesToLoad.length) {
        let fetcherKey =
          revalidatingFetchers[redirect3.idx - matchesToLoad.length].key;
  ...
  async function startRedirectNavigation(state2, redirect3, _temp2) {
    ...
    if (
      redirectPreserveMethodStatusCodes.has(redirect3.status) &&
      activeSubmission &&
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  let errors =
    (_dataRouterState2 = dataRouterState) == null
      ? void 0
      : _dataRouterState2.errors;
  if (errors != null) {
          ...
          React2.createElement(
            ...
            React2.createElement(
              ...
              state.initialized || router.future.v7_partialHydration
                ? React2.createElement(DataRoutes, {
...
react-router-dom/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MKGIUE3J.js.map
