  ...
  "node_modules/property-expr/index.js"(exports, module) {
    ...
    module.exports = {
      ...
      getter: function (path, safe) {
        ...
        return (
          getCache.get(path) ||
          getCache.set(path, function getter2(data) {
            var index = 0,
              len = parts.length;
            while (index < len) {
...
var mixed = {
  ...
  notType: ({ path, type, value, originalValue }) => {
    ...
    return type !== "mixed"
      ...
      : `${path} must match the configured type. The validated value was: \`${printValue(
          value,
          true
        )}\`` + castMsg;
  },
...
var Condition = class _Condition {
  static fromOptions(refs, config) {
    ...
    return new _Condition(refs, (values, schema) => {
      ...
      return (_branch = branch == null ? void 0 : branch(schema)) != null
        ? _branch
        : schema;
    });
  }
  ...
  resolve(base, options) {
    ...
    if (
      schema === void 0 || // @ts-ignore this can be base
      schema === base
    ) {
      return base;
    }
  ...
  function validate(
    ...
    function createError(overrides = {}) {
      ...
      const error = new ValidationError(
        ...
        nextParams.path,
        overrides.type || name,
        (_overrides$disableSta = overrides.disableStackTrace) != null
          ? _overrides$disableSta
          : disableStackTrace
      );
...
var NumberSchema = class extends Schema {
  ...
  round(method) {
    ...
    method =
      ((_method = method) == null ? void 0 : _method.toLowerCase()) || "round";
...
var deepHas = (obj, p) => {
  ...
  let last = path.pop();
  let parent = (0, import_property_expr.getter)(
    (0, import_property_expr.join)(path),
    true
  )(obj);
...
var ObjectSchema = class extends Schema {
  ...
  constantCase() {
    return this.transformKeys((key) =>
      (0, import_tiny_case.snakeCase)(key).toUpperCase()
    );
  }
  describe(options) {
    const next = (options ? this.resolve(options) : this).clone();
