...
function RenderStrokesWithDividerForm(
  props: RenderStrokesWithDividerFormProps
) {
  ...
  return (
    <RenderStrokesWithDividerFormUI
      formType={formType}
...
export { RenderStrokesWithDividerForm };
export type { RenderStrokesWithDividerFormProps };
